...
// BucketAccessNamespaceListerExpansion allows custom methods to be added to
// BucketAccessNamespaceLister.
type BucketAccessNamespaceListerExpansion interface{}
