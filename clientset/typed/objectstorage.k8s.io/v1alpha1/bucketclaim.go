...
func (c *bucketClaims) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.BucketClaim, err error) {
	result = &v1alpha1.BucketClaim{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *bucketClaims) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.BucketClaimList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.BucketClaimList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("bucketclaims").
...
// Watch returns a watch.Interface that watches the claimed bucketClaims.
func (c *bucketClaims) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *bucketClaims) Create(ctx context.Context, bucketClaim *v1alpha1.BucketClaim, opts v1.CreateOptions) (result *v1alpha1.BucketClaim, err error) {
	result = &v1alpha1.BucketClaim{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("bucketclaims").
...
func (c *bucketClaims) Update(ctx context.Context, bucketClaim *v1alpha1.BucketClaim, opts v1.UpdateOptions) (result *v1alpha1.BucketClaim, err error) {
	result = &v1alpha1.BucketClaim{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("bucketclaims").
...
func (c *bucketClaims) UpdateStatus(ctx context.Context, bucketClaim *v1alpha1.BucketClaim, opts v1.UpdateOptions) (result *v1alpha1.BucketClaim, err error) {
	result = &v1alpha1.BucketClaim{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("bucketclaims").
...
func (c *bucketClaims) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *bucketClaims) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *bucketClaims) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.BucketClaim, err error) {
	result = &v1alpha1.BucketClaim{}
